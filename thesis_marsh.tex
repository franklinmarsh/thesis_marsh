...
\caption{Observations of a contact binary, as returned by CRTS. Note that the observed flux varies significantly from observation to observation, but we cannot see the periodic nature of the variability with our eyes}
...
\citep{gettel2006catalog} a spline fit is employed. \citep{akerlof1994applicaiton} explanation of spline fit.
