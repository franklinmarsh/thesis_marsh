...
\Big( \frac{M_{\text{tau ceti}}}{M_{\odot}} \Big) = 0.78 \qquad \Big( \frac{L_{\text{tau ceti}}}{L_{\odot}} \Big) = \Big( \frac{M_{\text{tau ceti}}}{M_{\odot}} \Big)^{5.5} = 0.78^{5.5} \approx 0.25 L_{\odot}
\end{equation}
...
3. Fourier (Harmonic) Fit. \citep{rucinski1997eclipsing}
...
\begin{figure}
\centering
\includegraphics[scale = 0.75]{rd_amp.png}
...
\begin{figure}
\centering
\includegraphics[scale = 0.50]{metallicity_period.png}
\includegraphics[scale = 0.50]{metallicity_temp.png}
\caption{caption}
