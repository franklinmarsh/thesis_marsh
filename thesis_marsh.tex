...
\emph{ZAMS}\index{ZAMS, Zero-Age Main-Sequence} stands for Zero-Age Main-Sequence. \emph{TAMS}\index{TAMS, Terminal-Age Main-Sequence} stands for Terminal-Age Main-Sequence.
...
Astronomers have developed a set of geometrical elements that can describe the location of the photosphere with respect to the inner and outer Jacobi equipotentials\index{Jacobi equipotentials}\index{Roche equipotential}. 
...
At the onset of nuclear fusion, we say that the protostar has become a star, at Zero Age Main Sequence\index{Zero-Age Main Sequence} or (ZAMS)\index{ZAMS}.  
