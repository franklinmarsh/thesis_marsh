...
In this section, we will learn how physical models can be fit to observational light-curves.

The Wilson-Devinney Code \index{Wilson-Devinney Code} 
...
\begin{figure}
\begin{center}
\includegraphics[scale = 0.20]{example_lc_phase.png}
\includegraphics[scale = 0.20]{example_lc_resi.png}
