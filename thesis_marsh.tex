...
As we learned in \S\ref{sec: ZAMS to TAMS}, the characteristics of a main-sequence star change as it progresses through its main-sequence lifetime. As a main-sequence star progresses from ZAMS to TAMS\index{ZAMS}\index{TAMS}, its radius increases slightly, and its photosphere becomes  
