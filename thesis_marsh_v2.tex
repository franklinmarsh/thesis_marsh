...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.5]{ivezic2014statistics_10_15.png}
\caption{An example of a LS periodogram of unevenly spaced time-series data. The arrow marks the location of the true period. Fig. 10.15 from \citet{ivezic2014statistics}.}
\label{fig: lc_folded}
\end{figure}
